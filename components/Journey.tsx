...
export default function Journey() {
  return (
    <section id="journey" className="section-frame">
      <RevealSection>
        <div className="grid gap-6 sm:gap-8 lg:grid-cols-[120px_1fr]">
          <div className="reveal">
            <div className="font-display text-4xl text-link sm:text-6xl">04</div>
          ...
          <div>
            ...
            <ol className="reveal reveal-delay-2 mt-8 grid gap-px bg-ink sm:mt-10 sm:grid-cols-2 lg:grid-cols-4 list-none p-0">
              {site.loop.map((s) => (
